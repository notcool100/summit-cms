    ...
    private static async Task SeedCapabilitiesAsync(IServiceProvider sp, Dictionary<string, Guid> mediaMap)
    {
        ...
        [
            ("mechanical", "Mechanical & Piping", "Process, utility & high-purity systems",
                "Process, utility, and high-purity piping systems from 1/2\" tubing to 96\" headers in carbon, chrome-moly, stainless, and exotic alloys. In-house ASME code stamps, weld engineering, and NDE keep the critical path under one roof.",
            ...
            ("steel", "Structural Steel", "Erection at plant and terminal scale",
                "Heavy structural erection for processing plant support structures, conveyor trestles, and terminal structures. Our ironworker crews sequence with mechanical installation so steel never becomes the bottleneck.",
            ...
            ("underground", "Underground Infrastructure", "Deep utilities & duct banks",
                "Deep utility corridors, duct banks, and gravity systems beneath active construction sites. Engineered shoring, dewatering, and survey-grade as-builts protect everything built above.",
            ...
            ("equipment", "Equipment Setting", "Heavy rigging & precision placement",
                "Heavy rigging and millwright-grade placement of turbines, vessels, and process tools, set to thousandths with engineered lift plans reviewed by our own PEs.",
