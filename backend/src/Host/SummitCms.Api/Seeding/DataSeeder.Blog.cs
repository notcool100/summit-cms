        ...
        [
            ("what-18-million-safe-hours-requires",
                ...
                [
                    ...
                    "The harder discipline is on the busiest days. Fourteen consecutive months without a recordable incident on the Phoenix site happened while that corridor ran three shifts against a production start-up date that could not slip. Schedule pressure is exactly when safety habits either hold or quietly erode. Ours held because the stop-work call carries no penalty, ever, even when it turns out to be unnecessary.",
            ...
            ("inside-the-osm-yard",
                ...
                [
                    ...
                    "On Phoenix, that meant pre-fabricating 68% of the above-grade piping as complete modules, tested and stamped in the yard, then trucked in for set and tie-in. A module that fails hydrotest in our yard costs us a day. The same failure discovered after it is racked forty feet above an active plant floor costs the whole corridor.",
            ...
            ("pilbara-marine-terminal-mechanical-completion",
                "Pilbara Marine Terminal Reaches Mechanical Completion",
                ...
                [
                    "Pilbara Marine Terminal reached mechanical completion this month: 900,000 barrels of tank capacity, full process piping tie-ins, and instrumentation loop checks closed out ahead of the owner's turnover date.",
                    "This is the kind of project that does not make headlines outside the industry, which is exactly the point. Marine terminal work rewards a contractor who shows up, executes the scope as engineered, and does not generate change orders the owner did not ask for. That is what our tank farm crew did here, start to finish, without missing a single vessel loading window.",
            ...
            ("minerals-processing-buildout-mechanical-contracting",
                "The Pilbara Expansion Cycle Is Rewriting Mechanical Contracting",
                "Brownfield processing plant expansions do not run on the sequencing logic the rest of our industry was built around. Contractors who have not adapted to that are already behind.",
                ...
                [
                    "A decade ago, a mechanical contractor could staff up for a processing plant expansion using roughly the same sequencing playbook as a greenfield power plant or terminal: underground first, then structural, then piping, then tie-ins, mostly in that order. That playbook does not survive contact with a modern brownfield expansion schedule.",
                    "Mining clients are now running underground utilities, structural steel, and above-grade piping on parallel, interleaved schedules because the production start-up date is fixed years in advance and does not move for construction sequencing. On Phoenix, that meant running underground crews on a counter-flow schedule against an active processing plant's own construction front, always staying one grid ahead rather than waiting for a clean handoff.",
                    ...
                    "This is why we built out 4D scheduling and a dedicated modular fabrication yard specifically for brownfield expansion work, not because it was a nice capability to have, but because the traditional approach was no longer a viable way to bid this category of project."
                ]),

            ("winning-the-worksafe-wa-award",
